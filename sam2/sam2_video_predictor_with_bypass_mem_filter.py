...
from sam2.modeling.sam2_base_mem_filter import NO_OBJ_SCORE, SAM2Base
...
class SAM2VideoPredictor_bypass_mem_filter(sam2_bypass):
    ...
    @classmethod
    def from_pretrained(cls, model_id: str, **kwargs) -> "SAM2VideoPredictor_bypass_mem_filter":
        """
            ...
            if frame_idx %1 == 0:
                ...
                # if True:
                    ...
                    if self.mem_info['sel_win_id'] == None :
                        ...
                        if mask_win_id.shape[0] == 0 or any(x < 5 for x in self.mem_info['obj_scores']):
